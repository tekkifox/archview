...
If you want the workflow to refresh a Portainer stack after publishing, add a repository secret named `PORTAINER_WEBHOOK_URL` with the Portainer stack webhook URL. You can also support multiple webhooks by setting `PORTAINER_WEBHOOK_URLS` to a comma- or newline-separated list of URLs.
